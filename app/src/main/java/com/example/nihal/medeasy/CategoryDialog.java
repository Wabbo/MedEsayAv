        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < ids.size(); i++)
                    myRef1.child(Hawk.get(Constants.userID) + "").child("checkedCatgry").child(i + "").setValue(ids.get(i));
                Hawk.delete("ids");
                dismiss();
            }
        });
...
*/
    ...
    private void todelete(){
        ...
        myRef111.child(Hawk.get(Constants.userID)+"").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
